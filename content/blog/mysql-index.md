...
6,500万件もレコードがあるため、単純に`WHERE カラムA = xxx`で検索するだけで1~2分かかってしまう...
...
※ 実際の調査時にはもちろん[MySQL公式ドキュメント](https://dev.mysql.com/doc/refman/8.0/ja/innodb-online-ddl-limitations.html)も参照しましたのでご安心を。
...
- [mysqlリファレンス](https://dev.mysql.com/doc/refman/8.0/ja/innodb-online-ddl-limitations.html)
- [オンラインDDLについてのメモ](https://qiita.com/sioiriomame/items/b5c10cfa56c7c1f9a9ff)
- [オンラインDDLの概要](https://zenn.dev/akito_ima/articles/76ffb4efadbe01)
- [MySQLでメタデータロックを考慮してALTER TABLEする](https://tech.asoview.co.jp/entry/2024/12/12/000000)
