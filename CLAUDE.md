...
`content/article/` の記事を書く・レビューする・リライトするときは [.claude/skills/article/SKILL.md](./.claude/skills/article/SKILL.md) の方針に従ってください。1記事1メッセージと想定読者の設定、型別の全体構成、削るものの基準、フロントマターと callout の作法をまとめています。
