<template>
	<div class="space-y-12">
		<header class="space-y-4 border-b border-border pb-8">
			...
			<ul
				class="m-0 flex list-none flex-wrap gap-x-4 gap-y-1 p-0 font-mono text-meta text-sub"
			>
				<li
					v-for="link in links"
					:key="link.href"
		...
		<section class="space-y-3">
			<h2 class="font-mono text-ui uppercase tracking-marker text-main">About</h2>
		...
		<section class="space-y-3">
			<div class="flex items-baseline justify-between gap-4">
				<h2 class="font-mono text-ui uppercase tracking-marker text-main">Writing</h2>
				<NuxtLink
					to="/tags"
			...
			<div class="flex flex-wrap gap-3">
				...
				>
					<span>{{ tag.name }}</span>
					<span class="text-meta text-sub">{{ tag.count }}</span>
				</NuxtLink>
			</div>
		</section>

		<section class="space-y-3">
			<h2 class="font-mono text-ui uppercase tracking-marker text-main">This Blog</h2>
			<p class="leading-relaxed text-main">
